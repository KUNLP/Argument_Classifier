...
temp_ids = [ids.split('_')[0] for ids in train_ids]
...
def topic_modeling():
    ...
    topic_model.save('../../data/IAM/origin/topic_modeling_div0.1')

#topic_modeling()
topic_model = BERTopic.load('../../data/IAM/origin/topic_modeling_div0.1')
topics, probs = topic_model.fit_transform(train_sentences)
print(topic_model.get_topic_info())
#print(topic_model.topic_embeddings_)
# 88개의 topic_embeddings_
#topic_model.visualize_topics(width=1500, height=1500).write_html("../../data/IAM/origin/intertopic_dist_map_div0.1.html")
#topic_model.visualize_documents(train_sentences, width=2000, height=2000).write_html("../../data/IAM/origin/projections_div0.1.html")
topic_model.visualize_topics_per_class(topic_model.topics_per_class(train_sentences, temp_ids), width=1500, height=1500, top_n_topics=20).write_html('../../data/IAM/origin/topic_per_class_div.0.1.html')
# for i in range(10):
#     print(topic_model.transform(train_sentences[i]))
...
def make_pseudo_topic_with_bertopic(ids, sentences, topic_model, mode):
    ...
    with open('../../data/IAM/origin/{}_pseudo_topic_with_bertopic_div0.1.json'.format(mode), 'w', encoding='utf-8') as file:
