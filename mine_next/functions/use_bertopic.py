...
def topic_modeling():
    ...
    topic_model.save('../../data/IAM/origin/topic_modeling_div0.0')

topic_modeling()
topic_model = BERTopic.load('../../data/IAM/origin/topic_modeling_div0.0')
...
def make_pseudo_topic_with_bertopic(ids, sentences, topic_model, mode):
    ...
    with open('../../data/IAM/origin/{}_pseudo_topic_with_bertopic_div0.0.json'.format(mode), 'w', encoding='utf-8') as file:
