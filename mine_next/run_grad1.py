...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train_pseudo_topic', type=str, default='../data/IAM/origin/train_pseudo_topic_with_first_sent.json')
    # parser.add_argument('--dev_pseudo_topic', type=str, default='../data/IAM/origin/dev_pseudo_topic_with_first_sent.json')
    # parser.add_argument('--test_pseudo_topic', type=str, default='../data/IAM/origin/test_pseudo_topic_with_first_sent.json')
    parser.add_argument('--train_pseudo_topic', type=str,
                        default='../data/IAM/origin/train_pseudo_topic_with_bertopic_div0.2.json')
    parser.add_argument('--dev_pseudo_topic', type=str,
                        default='../data/IAM/origin/dev_pseudo_topic_with_bertopic_div0.2.json')
    parser.add_argument('--test_pseudo_topic', type=str,
                        default='../data/IAM/origin/test_pseudo_topic_with_bertopic_div0.2.json')
    ...
    parser.add_argument('--save_dir', type=str, default='pseudo_topic_with_bertopic_div02_base_graph_normal_only_pc_cons_768_feat_384_max_length_256_lr_3e5') # 모델 저장할 dir
    parser.add_argument('--output_dir', type=str, default='pseudo_topic_with_bertopic_div02_base_graph_normal_only_pc_cons_768_feat_384_max_length_256_lr_3e5') # 모델 불러올 dir
