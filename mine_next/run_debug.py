...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='only_sentence_base_graph_cons_256') # 모델 불러올 dir
    parser.add_argument('--output_dir', type=str, default='only_sentence_base_graph_cons_256') # 모델 저장할 dir
    ...
    parser.add_argument('--cons_hidden_size', type=int, default=256)
