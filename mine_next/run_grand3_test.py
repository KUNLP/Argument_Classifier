...
def create_model(args):
    ...
    model = RobertaReflectGraphWithGrandEdgeClassification.from_pretrained(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='only_sentence_base_only_grand_cons_768_feat_384_max_length_256_lr_3e5') # 모델 저장할 dir
    parser.add_argument('--output_dir', type=str, default='only_sentence_base_only_grand_cons_768_feat_384_max_length_256_lr_3e5') # 모델 불러올 dir
