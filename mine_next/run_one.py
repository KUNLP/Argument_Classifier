import argparse
from mine_next.functions.main_function2 import train, evaluate
import random, os
import numpy as np
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=int, default=8)
    parser.add_argument('--language_model', type=str, default='roberta-base')
    parser.add_argument("--epoch", type=int, default=30)
    parser.add_argument('--output_dir', type=str, default='only_sentence_base_graph_normal_only_pc_cons_768_feat_384_max_length_256_lr_3e5_with_pseudo_topic') # 모델 불러올 dir
    parser.add_argument('--save_dir', type=str, default='only_sentence_base_graph_normal_only_pc_cons_768_feat_384_max_length_256_lr_3e5_with_pseudo_topic') # 모델 저장할 dir
